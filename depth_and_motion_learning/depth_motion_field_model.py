...
from depth_and_motion_learning.dataset import reader_avt
...
DEFAULT_PARAMS = {
    ...
    'image_preprocessing': {
        ...
        'image_height': 128,
        'image_width': 416, #take same width as in paper but keep ratio -> 208 instead 128
    },
    'loss_weights': {
        'rgb_consistency': 1.0,
        'ssim': 3.0,
...
def input_fn(params):
  ...
  '''
  dataset = reader_avt.read_frame_pairs_from_data_path(
      params.input.data_path, params.input.reader)
